...
# lambda.draw = lambda_s.gprior/rchisq(1, lambda_v.gprior)
# 
# S = 50 # A limited number of draws are chosen for speed of estimation. This will be increased in the final submission.
# 
# Sigma.posterior.draws = array(NA, c(N,N,S))
# A.posterior.draws = array(NA, c((1+p*N),N,S))
# lambda.posterior.draws = rep(NA,S)
...
preds_ext = get_predictions(50, 20, tres$A.posterior.draws, tres$Sigma.posterior.draws)
